 ...
 */
import type { ContextResource } from './contextResource.js';
import type { DocumentResourceCursor } from './documentResourceCursor.js';
import type { EarlierResource } from './earlierResource.js';
import type { DocumentResourceItems } from './documentResourceItems.js';
import type { StreamResource } from './streamResource.js';
import type { TurnResource } from './turnResource.js';
import type { DocumentResourceTurnId } from './documentResourceTurnId.js';
import type { WaitResource } from './waitResource.js';

export interface DocumentResource {
  context: ContextResource;
  cursor: DocumentResourceCursor;
  earlier: EarlierResource;
  items: DocumentResourceItems;
  status: string;
  stream: StreamResource;
  turn: TurnResource;
  turnId: DocumentResourceTurnId;
  wait: WaitResource;
}
