 ...
 */
import type { ContextResourceCompactAt } from './contextResourceCompactAt.js';
import type { ContextResourceUsed } from './contextResourceUsed.js';
import type { ContextResourceWindow } from './contextResourceWindow.js';

export interface ContextResource {
  compactAt: ContextResourceCompactAt;
  model: string;
  used: ContextResourceUsed;
  warnAt: number;
  window: ContextResourceWindow;
}
