 ...
 */
import type { CreateChannelRequestBodyAllowFrom } from './createChannelRequestBodyAllowFrom.js';
import type { CreateChannelRequestBodyCredentials } from './createChannelRequestBodyCredentials.js';

export interface CreateChannelRequestBody {
  allowFrom?: CreateChannelRequestBodyAllowFrom;
  /** 平台侧凭据。只写不读，创建后无法取回 */
  credentials?: CreateChannelRequestBodyCredentials;
  /** @maxLength 128 */
  name: string;
  platform: string;
  senderPolicy?: string;
