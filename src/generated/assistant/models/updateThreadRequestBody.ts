 ...
 */
import type { UpdateThreadRequestBodyApprovalMode } from './updateThreadRequestBodyApprovalMode.js';

export interface UpdateThreadRequestBody {
  approvalMode?: UpdateThreadRequestBodyApprovalMode;
  archived?: boolean;
  model?: string;
