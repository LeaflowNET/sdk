 ...
 */
import type { ListChannelsResponseBodyChannels } from './listChannelsResponseBodyChannels.js';

export interface ListChannelsResponseBody {
  channels: ListChannelsResponseBodyChannels;
  total: number;
}
