 ...
 */
import type { PlatformListResponseBodyPlatforms } from './platformListResponseBodyPlatforms.js';

export interface PlatformListResponseBody {
  platforms: PlatformListResponseBodyPlatforms;
}
