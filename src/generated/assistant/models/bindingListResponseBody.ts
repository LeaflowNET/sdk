 ...
 */
import type { BindingListResponseBodyBindings } from './bindingListResponseBodyBindings.js';

export interface BindingListResponseBody {
  bindings: BindingListResponseBodyBindings;
  total: number;
}
