 ...
 */
import type { ModelResourceInputModalities } from './modelResourceInputModalities.js';
import type { ModelResourceReasoningTiers } from './modelResourceReasoningTiers.js';

export interface ModelResource {
  contextWindow: number;
  inputModalities: ModelResourceInputModalities;
  key: string;
  reasoningTiers: ModelResourceReasoningTiers;
}
