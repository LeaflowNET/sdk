 ...
 */
import type { SenderCheckResourceAllowFrom } from './senderCheckResourceAllowFrom.js';
import type { SenderCheckResourceBindingId } from './senderCheckResourceBindingId.js';
import type { SenderCheckResourceVerdict } from './senderCheckResourceVerdict.js';
export interface SenderCheckResource {
    allowFrom: SenderCheckResourceAllowFrom;
    allowed: boolean;
    bindingId: SenderCheckResourceBindingId;
    senderPolicy: string;
    verdict: SenderCheckResourceVerdict;
}
