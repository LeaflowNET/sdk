 ...
 */
import type { ChannelListResponseBodyChannels } from './channelListResponseBodyChannels.js';
export interface ChannelListResponseBody {
    channels: ChannelListResponseBodyChannels;
    total: number;
}
