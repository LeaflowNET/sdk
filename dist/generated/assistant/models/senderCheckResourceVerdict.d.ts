 ...
 */
export type SenderCheckResourceVerdict = typeof SenderCheckResourceVerdict[keyof typeof SenderCheckResourceVerdict];
export declare const SenderCheckResourceVerdict: {
    readonly ALLOWED_BY_BINDING: "ALLOWED_BY_BINDING";
    readonly ALLOWED_BY_ALLOW_FROM: "ALLOWED_BY_ALLOW_FROM";
    readonly ALLOWED_BY_POLICY: "ALLOWED_BY_POLICY";
    readonly REJECTED_NOT_ALLOWED: "REJECTED_NOT_ALLOWED";
};
