 ...
 */
import type { ThreadSummaryResourceApprovalMode } from './threadSummaryResourceApprovalMode.js';
import type { ThreadSummaryResourceTitle } from './threadSummaryResourceTitle.js';
export interface ThreadSummaryResource {
    approvalMode: ThreadSummaryResourceApprovalMode;
    archived: boolean;
    createdAt: string;
    id: string;
    model: string;
    title: ThreadSummaryResourceTitle;
    unread: boolean;
    updatedAt: string;
}
