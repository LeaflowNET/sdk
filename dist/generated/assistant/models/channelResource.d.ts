 ...
 */
import type { ChannelResourceAllowFrom } from './channelResourceAllowFrom.js';
import type { ChannelResourceWebhookUrl } from './channelResourceWebhookUrl.js';
export interface ChannelResource {
    allowFrom: ChannelResourceAllowFrom;
    createdAt: string;
    id: string;
    name: string;
    platform: string;
    ...
    webhookUrl: ChannelResourceWebhookUrl;
}
