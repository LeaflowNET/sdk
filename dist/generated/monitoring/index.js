...
* @summary 列出告警
*/
export const listIncidents = (params, options) => {
 ...
 * @summary 查一条告警
 */
export const getIncident = (incidentId, options) => {
 ...
 * @summary 确认这条告警
 */
export const acknowledgeIncident = (incidentId, acknowledgeIncidentRequestBody, options) => {
 ...
 */
export const assignIncident = (incidentId, assignIncidentRequestBody, options) => {
 ...
 * @summary 了结这条告警
 */
export const closeIncident = (incidentId, closeIncidentRequestBody, options) => {
 ...
 * @summary 在时间线上写一条备注
 */
export const addIncidentComment = (incidentId, addCommentRequestBody, options) => {
 ...
 */
export const setIncidentFollowing = (incidentId, setFollowingRequestBody, options) => {
 ...
 */
export const reopenIncident = (incidentId, options) => {
 ...
 * @summary 列出这条告警的时间线
 */
export const listIncidentTimeline = (incidentId, params, options) => {
 ...
 * @summary 列出维护窗口
 */
export const listMaintenanceWindows = (options) => {
 ...
 * @summary 撤掉一个维护窗口
 */
export const deleteMaintenanceWindow = (windowId, options) => {
 ...
 * @summary 查一个维护窗口
 */
export const getMaintenanceWindow = (windowId, options) => {
 ...
 */
export const putMaintenanceWindow = (windowId, putMaintenanceWindowRequestBody, options) => {
 ...
 * @summary 列出项目里的机器
 */
export const listServers = (params, options) => {
 ...
 * @summary 删掉这台机器
 */
export const deleteServer = (serverId, options) => {
 ...
 * @summary 查一台机器的接入情况
 */
export const getServer = (serverId, options) => {
 ...
 * @summary 改一台机器的接入参数
 */
export const updateServer = (serverId, updateServerRequestBody, options) => {
 ...
 * @summary 把一台机器接入监控
 */
export const enableServerMonitoring = (serverId, enableMonitoringRequestBody, options) => {
 ...
 * @summary 停止监控这台机器
 */
export const disableServerMonitoring = (serverId, options) => {
 ...
 * @summary 列出一台机器的监控项
 */
export const listServerItems = (serverId, params, options) => {
 ...
 * @summary 取一个监控项的时间序列
 */
export const getServerMetric = (serverId, params, options) => {
 ...
 */
export const rotateAgentPsk = (serverId, options) => {
 ...
 * @summary 一台机器的硬件与接口
 */
export const getServerResources = (serverId, options) => {
 ...
 * @summary 一台机器此刻的状态
 */
export const getServerSnapshot = (serverId, options) => {
 ...
 * @summary 删掉一个网页检查
 */
export const deleteWebCheck = (serverId, checkId, options) => {
 ...
 * @summary 查一个网页检查
 */
export const getWebCheck = (serverId, checkId, options) => {
 ...
 */
export const putWebCheck = (serverId, checkId, putWebCheckRequestBody, options) => {
 ...
 * @summary 查实测的达成情况
 */
export const getSliReport = (params, options) => {
 ...
 */
export const deleteSlo = (options) => {
 ...
 */
export const putSlo = (putSLORequestBody, options) => {
 ...
 * @summary 某个指标最高的前几台
 */
export const listProjectTopItems = (params, options) => {
 ...
 * @summary 列出网页检查
 */
export const listWebChecks = (params, options) => {
