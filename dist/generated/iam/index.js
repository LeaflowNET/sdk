...
* @summary 列出注册必须同意的文件
*/
export const listAgreements = (options) => {
 ...
 * @summary 列出我同意过的文件
 */
export const listConsents = (options) => {
 ...
 * @summary 同意条款
 */
export const acceptAgreements = (acceptConsentsRequestBody, options) => {
 ...
 * @summary 查看实名核验状态
 */
export const getIdentityVerification = (options) => {
 ...
 * @summary 提交实名核验材料
 */
export const submitIdentityVerification = (submitIdentityVerificationRequestBody, options) => {
 ...
 * @summary 列出寄给我的要约
 */
export const listMyInvitations = (params, options) => {
 ...
 * @summary 顺着邀请链接接受
 */
export const acceptInvitationByToken = (acceptInvitationByTokenRequestBody, options) => {
 ...
 */
export const acceptInvitation = (invitationId, options) => {
 ...
 */
export const listPermissions = (options) => {
 ...
 * @summary 列出我参与的项目
 */
export const listProjects = (params, options) => {
 ...
 * @summary 建一个项目
 */
export const createProject = (createProjectRequestBody, options) => {
 ...
 * @summary 改项目的名称与描述
 */
export const updateProject = (projectId, updateProjectRequestBody, options) => {
 ...
 */
export const listProjectInvitations = (projectId, params, options) => {
 ...
 * @summary 发出一份邀请
 */
export const issueInvitation = (projectId, issueInvitationRequestBody, options) => {
 ...
 */
export const revokeInvitation = (projectId, invitationId, options) => {
 ...
 * @summary 列出项目成员
 */
export const listMembers = (projectId, params, options) => {
 ...
 * @summary 移除成员，或者自己退出
 */
export const removeMember = (projectId, userId, options) => {
 ...
 * @summary 设置一个成员持有的角色
 */
export const setMemberRoles = (projectId, userId, setMemberRolesRequestBody, options) => {
 ...
 */
export const getProjectMembership = (projectId, options) => {
 ...
 * @summary 列出项目里的角色
 */
export const listRoles = (projectId, options) => {
 ...
 * @summary 建一个角色
 */
export const createRole = (projectId, createRoleRequestBody, options) => {
 ...
 * @summary 删一个角色
 */
export const deleteRole = (projectId, code, options) => {
 ...
 * @summary 查看一个角色
 */
export const getRole = (projectId, code, options) => {
 ...
 * @summary 改一个角色
 */
export const updateRole = (projectId, code, updateRoleRequestBody, options) => {
 ...
 * @summary 列出这个项目的公钥
 */
export const listSshKeys = (projectId, params, options) => {
 ...
 * @summary 添加一把公钥
 */
export const createSshKey = (projectId, createSSHKeyRequestBody, options) => {
 ...
 * @summary 吊销一把公钥
 */
export const revokeSshKey = (projectId, keyId, options) => {
 ...
 * @summary 查看一把公钥
 */
export const getSshKey = (projectId, keyId, options) => {
 ...
 * @summary 给公钥改名
 */
export const renameSshKey = (projectId, keyId, renameSSHKeyRequestBody, options) => {
 ...
 * @summary 换一张项目令牌
 */
export const exchangeProjectToken = (projectId, options) => {
 ...
 * @summary 转移项目所有权
 */
export const transferProjectOwnership = (projectId, transferOwnershipRequestBody, options) => {
 ...
 * @summary 注册账号
 */
export const register = (registerRequestBody, options) => {
