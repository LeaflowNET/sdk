 ...
 */
import type { AcceptConsentsRequestBody, AcceptInvitationByTokenRequestBody, AcceptInvitationResponseBody, AccountResource, CreateProjectRequestBody, CreateProjectSSHKeyRequestBody, CreateRoleRequestBody, CreateUserSSHKeyRequestBody, ExchangeTokenResponseBody, IdentityVerificationResource, IssueInvitationRequestBody, IssueInvitationResponseBody, ListAgreementsResponseBody, ListConsentsResponseBody, ListInvitationsResponseBody, ListMembersParams, ListMembersResponseBody, ListMyInvitationsParams, ListMySshKeysParams, ListPermissionsResponseBody, ListProjectInvitationsParams, ListProjectSshKeysParams, ListProjectsParams, ListProjectsResponseBody, ListRolesResponseBody, ListSSHKeysResponseBody, MemberResource, MembershipResource, ProjectListItem, RegisterRequestBody, RenameProjectSSHKeyRequestBody, RenameUserSSHKeyRequestBody, RoleResource, SSHKeyResource, SetMemberRolesRequestBody, SubmitIdentityVerificationRequestBody, TransferOwnershipRequestBody, TransferOwnershipResponseBody, UpdateProjectRequestBody, UpdateRoleRequestBody } from './models/index.js';
/**
...
* @summary 列出注册必须同意的文件
*/
export declare const listAgreements: () => Promise<ListAgreementsResponseBody>;
/**
 ...
 * @summary 列出我同意过的文件
 */
export declare const listConsents: () => Promise<ListConsentsResponseBody>;
/**
 ...
 * @summary 列出寄给我的要约
 */
export declare const listMyInvitations: (params?: ListMyInvitationsParams) => Promise<ListInvitationsResponseBody>;
/**
 * token 对不上和这份要约已经不作数了是同一个回答：持有者对这两种情况能做的事完全一样，分开报会把这个接口变成一个可以拿来试 token 的探针。
 * @summary 顺着邀请链接接受
 */
export declare const acceptInvitationByToken: (acceptInvitationByTokenRequestBody: AcceptInvitationByTokenRequestBody) => Promise<AcceptInvitationResponseBody>;
/**
 * 不需要 token：token 证明的是「你就是这份要约寄给的那个人」，而当前账号的邮箱对得上这份要约，证明的是同一件事。
 * @summary 接受一份列在我名下的要约
 */
export declare const acceptInvitation: (invitationId: string) => Promise<AcceptInvitationResponseBody>;
/**
 * @summary 列出我的公钥
 */
export declare const listMySshKeys: (params?: ListMySshKeysParams) => Promise<ListSSHKeysResponseBody>;
/**
 * @summary 添加一把我的公钥
 */
 ...
 */
export declare const listPermissions: () => Promise<ListPermissionsResponseBody>;
/**
 * 默认不含已删除的项目——那些是已经不存在了的东西，要看必须明确用 status=DELETED 点名。
 * @summary 列出我参与的项目
 */
export declare const listProjects: (params?: ListProjectsParams) => Promise<ListProjectsResponseBody>;
/**
 * 建的人就是所有者。项目会连带预置 OWNER、ADMIN 两个内置角色和一个空权限的 member 角色。
 * @summary 建一个项目
 */
export declare const createProject: (createProjectRequestBody: CreateProjectRequestBody) => Promise<ProjectListItem>;
/**
 ...
 * @summary 改项目的名称与描述
 */
export declare const updateProject: (projectId: string, updateProjectRequestBody: UpdateProjectRequestBody) => Promise<ProjectListItem>;
/**
 * 在项目里就看得到，和成员列表同一条规则：谁被请了也是「这个项目有谁」的一部分。
 * @summary 列出这个项目还在等的要约
 */
export declare const listProjectInvitations: (projectId: string, params?: ListProjectInvitationsParams) => Promise<ListInvitationsResponseBody>;
/**
 * 要约站 14 天。有上限是因为里面那些角色是按发出那一刻的项目校验的，一份活得比它所依据的安排还久的要约会授出现在没人打算授的权限。
 * @summary 发出一份邀请
 */
export declare const issueInvitation: (projectId: string, issueInvitationRequestBody: IssueInvitationRequestBody) => Promise<IssueInvitationResponseBody>;
/**
 ...
 * @summary 列出项目成员
 */
export declare const listMembers: (projectId: string, params?: ListMembersParams) => Promise<ListMembersResponseBody>;
/**
 ...
 * @summary 列出项目里的角色
 */
export declare const listRoles: (projectId: string) => Promise<ListRolesResponseBody>;
/**
 * @summary 建一个角色
 */
 ...
 * @summary 列出项目的公钥
 */
export declare const listProjectSshKeys: (projectId: string, params?: ListProjectSshKeysParams) => Promise<ListSSHKeysResponseBody>;
/**
 * @summary 给项目添加一把公钥
 */
 ...
 * @summary 换一张项目令牌
 */
export declare const exchangeProjectToken: (projectId: string) => Promise<ExchangeTokenResponseBody>;
/**
 * OWNER 唯一的移动方式，只有所有者本人能发起——能像普通角色那样授予的话，任何管理员都可以顺手把自己变成所有者。
 * @summary 转移项目所有权
 */
export declare const transferProjectOwnership: (projectId: string, transferOwnershipRequestBody: TransferOwnershipRequestBody) => Promise<TransferOwnershipResponseBody>;
/**
